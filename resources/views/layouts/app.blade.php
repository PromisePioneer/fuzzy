...
<head><base href="">
    <title>
        Sistem Penentuan Pengurangan Uang Kuliah Tunggal (UKT) Mahasiswa Baru Berbasis Logika Fuzzy
    </title>
                ...
                <div class="toolbar">
                    ...
                    <div class="container-fluid py-6 py-lg-0 d-flex flex-column flex-lg-row align-items-lg-stretch justify-content-lg-between">
                        ...
                        <div class="page-title d-flex flex-column me-5">
                            <!--begin::Title-->
                            <h1 class="d-flex flex-column text-dark fw-bolder fs-3 mb-0">@yield('page_big_title')</h1>
                        </div>
                        <!--end::Page title-->
                        <!--begin::Action group-->
                    </div>
                                ...
                                <div class="card card-xl-stretch mb-5 mb-xl-8">
                                    ...
                                    <div class="card-header border-0 pt-5">
                                        ...
                                        <h3 class="card-title align-items-start flex-column">
                                            <span class="card-label fw-bolder fs-3 mb-1">@yield('page_title')</span>
                                            <span class="text-muted fw-bold fs-7">@yield('page_sub_title')</span>
                                        </h3>
                                        <!--end::Title-->
                                        <!--begin::Toolbar-->
                                        <!--end::Toolbar-->
            ...
            <div class="footer py-4 d-flex flex-lg-column" id="kt_footer">
                <div class="container-fluid d-flex flex-column flex-md-row align-items-center justify-content-between">
                    <div class="text-dark order-2 order-md-1">
                        <span class="text-muted fw-bold me-1">UGM©</span>
                        <a href="https://keenthemes.com" target="_blank" class="text-gray-800 text-hover-primary">Velssy UGM</a>
                    </div>
                    <!--end::Copyright-->
                    <!--begin::Menu-->
